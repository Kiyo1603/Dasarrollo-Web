...
`,c={root:function(n){var i=n.instance,r=n.props;return["p-inputtext p-component",{"p-filled":i.$filled,"p-inputtext-sm p-inputfield-sm":r.size==="small","p-inputtext-lg p-inputfield-lg":r.size==="large","p-invalid":i.$invalid,"p-variant-filled":i.$variant==="filled","p-inputtext-fluid":i.$fluid}]}},f=u.extend({name:"inputtext",style:s,classes:c}),x={name:"BaseInputText",extends:p,style:f,provide:function(){return{$pcInputText:this,$parentInstance:this}}},$={name:"InputText",extends:x,inheritAttrs:!1,methods:{onInput:function(n){this.writeValue(n.target.value,n)}},computed:{attrs:function(){return a(this.ptmi("root",{context:{filled:this.$filled,disabled:this.disabled}}),this.formField)}}},g=["value","name","disabled","aria-invalid"];function v(t,n,i,r,b,e){return l(),d("input",a({type:"text",class:t.cx("root"),value:t.d_value,name:t.name,disabled:t.disabled,"aria-invalid":t.$invalid||void 0,onInput:n[0]||(n[0]=function(){return e.onInput&&e.onInput.apply(e,arguments)})},e.attrs),null,16,g)}$.render=v;export{p as a,$ as s};
