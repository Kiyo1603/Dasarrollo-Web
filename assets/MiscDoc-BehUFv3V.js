import{B as $,c as f,o as u,F as B,i as S,E as A,I as l,t as K,H as D,L as T,S as x,C,d as n,a,Q as w,P as y,ax as V,Z as k,ae as W,w as h,T as N,r as O,e as G,aU as j,J}from"./index-B63GrNPr.js";import{s as Z}from"./index-_p8-G5Ed.js";import{s as Q}from"./index-BodBYDfM.js";import{s as _}from"./index-u8hkGudQ.js";import{s as U}from"./index-Bz8ZMrvK.js";import{a as z}from"./index-D0GNYzqW.js";import{s as ee}from"./index-C8fFgcja.js";var te=({dt:e})=>`
.p-avatar {
    display: inline-flex;
    align-items: center;
...
`,ne={root:function(t){var i=t.props;return["p-avatar p-component",{"p-avatar-image":i.image!=null,"p-avatar-circle":i.shape==="circle","p-avatar-lg":i.size==="large","p-avatar-xl":i.size==="xlarge"}]},label:"p-avatar-label",icon:"p-avatar-icon"},re=$.extend({name:"avatar",style:te,classes:ne}),se={name:"BaseAvatar",extends:x,props:{label:{type:String,default:null},icon:{type:String,default:null},image:{type:String,default:null},size:{type:String,default:"normal"},shape:{type:String,default:"square"},ariaLabelledby:{type:String,default:null},ariaLabel:{type:String,default:null}},style:re,provide:function(){return{$pcAvatar:this,$parentInstance:this}}},P={name:"Avatar",extends:se,inheritAttrs:!1,emits:["error"],methods:{onError:function(t){this.$emit("error",t)}}},ae=["aria-labelledby","aria-label"],ie=["src","alt"];function oe(e,t,i,o,d,s){return u(),f("div",l({class:e.cx("root"),"aria-labelledby":e.ariaLabelledby,"aria-label":e.ariaLabel},e.ptmi("root")),[B(e.$slots,"default",{},function(){return[e.label?(u(),f("span",l({key:0,class:e.cx("label")},e.ptm("label")),K(e.label),17)):e.$slots.icon?(u(),S(T(e.$slots.icon),{key:1,class:D(e.cx("icon"))},null,8,["class"])):e.icon?(u(),f("span",l({key:2,class:[e.cx("icon"),e.icon]},e.ptm("icon")),null,16)):e.image?(u(),f("img",l({key:3,src:e.image,alt:e.ariaLabel,onError:t[0]||(t[0]=function(){return s.onError&&s.onError.apply(s,arguments)})},e.ptm("image")),null,16,ie)):A("",!0)]})],16,ae)}P.render=oe;var le={root:"p-avatar-group p-component"},ce=$.extend({name:"avatargroup",classes:le}),ue={name:"BaseAvatarGroup",extends:x,style:ce,provide:function(){return{$pcAvatarGroup:this,$parentInstance:this}}},F={name:"AvatarGroup",extends:ue,inheritAttrs:!1};function de(e,t,i,o,d,s){return u(),f("div",l({class:e.cx("root")},e.ptmi("root")),[B(e.$slots,"default")],16)}F.render=de;var pe=({dt:e})=>`
.p-overlaybadge {
    position: relative;
}
...
`,me={root:"p-overlaybadge"},fe=$.extend({name:"overlaybadge",style:pe,classes:me}),ve={name:"OverlayBadge",extends:z,style:fe,provide:function(){return{$pcOverlayBadge:this,$parentInstance:this}}},R={name:"OverlayBadge",extends:ve,inheritAttrs:!1,components:{Badge:z}};function he(e,t,i,o,d,s){var r=C("Badge");return u(),f("div",l({class:e.cx("root")},e.ptmi("root")),[B(e.$slots,"default"),n(r,l(e.$props,{pt:e.ptm("pcBadge")}),null,16,["pt"])],16)}R.render=he;var ge=({dt:e})=>`
