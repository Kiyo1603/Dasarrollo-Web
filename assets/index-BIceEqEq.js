import{B as o,c as e,o as r,E as l,I as i,F as p,f as d,t as u,S as b}from"./index-LPcvaDST.js";var m=({dt:n})=>`
.p-progressbar {
    position: relative;
    overflow: hidden;
...
`,g={root:function(a){var t=a.instance;return["p-progressbar p-component",{"p-progressbar-determinate":t.determinate,"p-progressbar-indeterminate":t.indeterminate}]},value:"p-progressbar-value",label:"p-progressbar-label"},c=o.extend({name:"progressbar",style:m,classes:g}),v={name:"BaseProgressBar",extends:b,props:{value:{type:Number,default:null},mode:{type:String,default:"determinate"},showValue:{type:Boolean,default:!0}},style:c,provide:function(){return{$pcProgressBar:this,$parentInstance:this}}},f={name:"ProgressBar",extends:v,inheritAttrs:!1,computed:{progressStyle:function(){return{width:this.value+"%",display:"flex"}},indeterminate:function(){return this.mode==="indeterminate"},determinate:function(){return this.mode==="determinate"}}},h=["aria-valuenow"];function y(n,a,t,k,w,s){return r(),e("div",i({role:"progressbar",class:n.cx("root"),"aria-valuemin":"0","aria-valuenow":n.value,"aria-valuemax":"100"},n.ptmi("root")),[s.determinate?(r(),e("div",i({key:0,class:n.cx("value"),style:s.progressStyle},n.ptm("value")),[n.value!=null&&n.value!==0&&n.showValue?(r(),e("div",i({key:0,class:n.cx("label")},n.ptm("label")),[p(n.$slots,"default",{},function(){return[d(u(n.value+"%"),1)]})],16)):l("",!0)],16)):s.indeterminate?(r(),e("div",i({key:1,class:n.cx("value")},n.ptm("value")),null,16)):l("",!0)],16,h)}f.render=y;export{f as s};
